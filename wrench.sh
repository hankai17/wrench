...
function version {
	...
	echo -e "$AUTHOR"
	echo "wrench - A TCP performance profiling tool."
	echo ""
}
...
function usage {
	...
	echo "  -m            # compile as wrench.ko instead of running directly"
...
#-C "gcc -O2 -Wall -Werror=missing-prototypes -Werror=int-conversion" \
